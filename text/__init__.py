...
from text.japanese.phonemizer import japanese_text_to_phonemes
from text.symbols import _bos, _eos, _punctuations, make_symbols, phonemes, symbols
...
def phoneme_to_sequence(
    ...
    if return_phonemes:
        return sequence, _phonemes_to_id
    else:
        return sequence
