...
from dataset import PartitionPerEpochDataModule
...
def fit_model(model_config, data_config, train_config):
    ...
    datamodule = PartitionPerEpochDataModule(data_config, train_config.batch_size, train_config.num_workers)
    ...
    trainer.fit(model, datamodule,
                ckpt_path=train_config.resume_from_checkpoint)
